...
export default function gyeonggi({ sheetData }) {
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://wdkor.co.kr/gyeonggi" />
        ...
        <meta property="og:url" content="https://wdkor.co.kr/gyeonggi" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="웨딩박람회 일정 총정리" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="경기웨딩박람회 일정 안내 | 2025년 최신 업데이트" />
        <meta name="twitter:description" content="경기 지역의 2025년 최신 웨딩박람회 일정과 장소, 혜택을 한눈에 확인하세요." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://wdkor.co.kr/gyeonggi"
            })
          }}
        />
      </Head>
