...
export default function 수원웨딩박람회({ sheetData }) {
  return (
    <>
      <Head>
        <title>2025 수원웨딩박람회 일정 총정리 | 최신 박람회 정보</title>
        <meta
          name="description"
          content="2025년 수원웨딩박람회 일정을 한눈에 확인하세요! 최신 박람회 정보와 혜택을 놓치지 마세요."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <link rel="canonical" href="https://wdkor.co.kr/suwon-wedding-fair" />
        <meta property="og:title" content="2025 수원웨딩박람회 일정 총정리" />
        <meta property="og:description" content="2025년 수원웨딩박람회 일정을 한눈에 확인하세요!" />
        ...
        <meta name="twitter:title" content="2025 수원웨딩박람회 일정 총정리" />
        <meta name="twitter:description" content="2025년 수원웨딩박람회 일정을 한눈에 확인하세요!" />
        <meta name="keywords" content="수원웨딩박람회, 2025웨딩박람회, 수원웨딩, 웨딩박람회일정" />
      ...
      <main>
        <div className="container" style={{ padding: '30px' }}>
          ...
          {(() => {
            const currentRegionData = sheetData.filter((row) => row[0] === '수원');
            const otherRegionData = sheetData.filter((row) => row[0] !== '수원');
