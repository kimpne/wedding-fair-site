...
export default function incheon({ sheetData }) {
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://wdkor.co.kr/incheon" />
        ...
        <meta property="og:url" content="https://wdkor.co.kr/incheon" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="웨딩박람회 일정 총정리" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="인천웨딩박람회 일정 안내 | 2025년 최신 업데이트" />
        <meta name="twitter:description" content="인천 지역의 2025년 최신 웨딩박람회 일정과 장소, 혜택을 한눈에 확인하세요." />
      ...
      <main>
        <div className="container" style={{ padding: '30px' }}>
          ...
          {(() => {
            const currentRegionData = sheetData.filter((row) => row[0] === '인천');
            const otherRegionData = sheetData.filter((row) => row[0] !== '인천');
