...
export default function seoul({ sheetData }) {
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://wdkor.co.kr/seoul" />
        ...
        <meta property="og:url" content="https://wdkor.co.kr/seoul" />
