...
export default function jeonju({ sheetData }) {
  return (
    <>
      <Head>
        <title>전주웨딩박람회 일정 안내 | 2025년 최신 업데이트</title>
        ...
        <link rel="canonical" href="https://wdkor.co.kr/jeonju" />
        <meta property="og:title" content="전주웨딩박람회 일정 안내 | 2025년 최신 업데이트" />
        <meta property="og:description" content="전주 지역의 2025년 최신 웨딩박람회 일정과 장소, 혜택을 한눈에 확인하세요." />
        <meta property="og:url" content="https://wdkor.co.kr/jeonju" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="웨딩박람회 일정 총정리" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="전주웨딩박람회 일정 안내 | 2025년 최신 업데이트" />
        <meta name="twitter:description" content="전주 지역의 2025년 최신 웨딩박람회 일정과 장소, 혜택을 한눈에 확인하세요." />
      ...
      <main>
        <div className="container" style={{ padding: '30px' }}>
          ...
          {(() => {
            ...
            const otherRegionData = sheetData.filter((row) => row[0] !== '전주');
